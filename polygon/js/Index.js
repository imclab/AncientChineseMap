(function() {
	...
	p.drawDepthMap = function() {
        ...
        for ( var i=0; i<(NUM-1); i++) {
            for ( var j=0; j< (NUM-1); j++) {
				...
				this.model.updateAttribute(0, index*4,     [ n0[0], n0[1], n0[2] ]);
				this.model.updateAttribute(0, index*4+1,   [ n0[0], n0[1], n0[2] ]);
				this.model.updateAttribute(0, index*4+2,   [ n0[0], n0[1], n0[2] ]);
				this.model.updateAttribute(0, index*4+3,   [ n1[0], n1[1], n1[2] ]);
            }
        }
	...
	p.render = function() {
        ...
        mat4.toInverseMat3(this.camera.update(), normalMatrix);
